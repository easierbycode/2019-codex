...
, function(t, e, o) {
    ...
    var pi = function(t) {
        function e() {
            ...
            o = this,
            (t = !(i = ci(e).call(this)) || "object" !== hi(i) && "function" != typeof i ? di(o) : i).hudSpbtnBg1 = new PIXI.Sprite(PIXI.Texture.fromFrame("hudSpbtnBg1.gif")),
            t.hudSpbtnBg1.x = 32,
            t.hudSpbtnBg1.y = 32,
            t.hudSpbtnBg1.alpha = 0,
            t.hudSpbtnBg1.anchor.set(.5),
            t.hudSpbtnBg0 = new PIXI.Sprite(PIXI.Texture.fromFrame("hudSpbtnBg0.gif")),
            t.hudSpbtnBg0.x = -18,
            t.hudSpbtnBg0.y = -18,
            t.hudSpbtnBg0.alpha = 0,
            t.spGageBarBg = new PIXI.Sprite(PIXI.Texture.fromFrame("hudSpbtn100per.gif")),
            t.spGageBarMask = new PIXI.Graphics,
            t.spGageBarMask.drawRect(0, 0, 50, -50),
            t.spGageBarMask.x = 8,
            t.spGageBarMask.y = 58,
            t.spGageBarMask.scale.y = 0,
            t.spGageBar = new PIXI.Sprite(PIXI.Texture.fromFrame("hudSpbtn0per.gif")),
        ...
        (i = [{
            ...
            value: function() {
                ...
                TweenMax.to(this.hudSpbtnBg1.scale, .5, {
                    x: 1,
                    y: 1
                }),
